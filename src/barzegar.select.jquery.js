(function ($) {
    var DEFAULT_SETTINGS={
        ...
        addBtnText: "افزودن",
        deleteIcon: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 43.94 43.94" style="width: 7px;height:7px;">
          <g>
            <path d="m29.04,21.97l13.44-13.44c.94-.94,1.46-2.19,1.46-3.53s-.52-2.59-1.46-3.54c-.95-.94-2.2-1.46-3.54-1.46s-2.59.52-3.5,1.43l-13.23,13.71L8.53,1.46c-.94-.94-2.19-1.46-3.53-1.46S2.41.52,1.46,1.46c-.94.95-1.46,2.2-1.46,3.54s.52,2.59,1.43,3.5l13.95,13.47L1.46,35.41c-.94.94-1.46,2.19-1.46,3.53s.52,2.59,1.46,3.54c.95.94,2.2,1.46,3.54,1.46s2.59-.52,3.53-1.46l13.68-13.68,13.2,13.68c.94.94,2.19,1.46,3.53,1.46s2.59-.52,3.54-1.46c.94-.95,1.46-2.2,1.46-3.54s-.52-2.59-1.46-3.53l-13.44-13.44Z"/>
          </g>
        </g>
      </svg>`,
